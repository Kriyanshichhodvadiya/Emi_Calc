...
import 'package:emi_calc/controller/new_account_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';

import '../common/common_widget.dart';
import '../common/senior_citizen_common.dart';
...
class NewAccount extends StatelessWidget {
  ...
  NewAccountController controller = Get.put(NewAccountController());
              ...
              children: [
                ...
                commonTextField(
                  ...
                  validator: (value) {
                    ...
                    if (rate == null) {
                      return 'Please enter a valid Annual rate.';
                    }
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Obx(() => commonLabel(
                                  label:
                                      "${controller.maturityAmountValue.value.toStringAsFixed(0)} ₹")),
                            ],
                          ),
                          Divider(
                            height: 30,
                          ...
                          Obx(
                            () => dataRow(
                              text: "Total Deposit",
                              amount:
                                  "${controller.totalDepositValue.value.toStringAsFixed(0)} ₹",
                            ),
                          ),
                          Divider(
                            height: 30,
                          ...
                          Obx(
                            () => dataRow(
                              text: "Total Interest",
                              amount:
                                  "${controller.totalInterestValue.value.toStringAsFixed(0)} ₹",
                            ),
                          ),
                        ],
                      ),
