...
import '../controller/sukanya_controller.dart';

class Sukanya extends StatelessWidget {
  Sukanya({super.key});
  SukanyaController controller = Get.put(SukanyaController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: commonappbar(text: "Sukanya Samriddhi Account"),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                20.height,
                seniorCitizenRow(
                    fontSize: 12, label: "Deposit Period", text: "15 Year"),
                20.height,
                seniorCitizenRow(
                    fontSize: 12, label: "Maturity Period:", text: "21 years"),
                30.height,
                Row(
                  children: [
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(
                            () => dataRow(
                              text: "Total Deposit",
                              amount: "${controller.totalDepositValue.value} ₹",
                            ),
                          ),
                          Divider(
                            height: 30,
