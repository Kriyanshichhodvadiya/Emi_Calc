...
import 'package:emi_calc/controller/senior_citizen_controller.dart';
...
class SeniorCitizen extends StatelessWidget {
  SeniorCitizen({super.key});
  SeniorCitizenController controller = Get.put(SeniorCitizenController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: commonappbar(text: "Senior Citizen Saving Scheme"),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                20.height,
                seniorCitizenRow(label: "Term", text: "5 years"),
                30.height,
                Row(
                  children: [
                    Expanded(
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child:
                                    commonLabel(label: "Quarterly Interest:"),
                              ),
                              Obx(() => commonLabel(
                                  label:
                                      "${controller.quarterlyInterest.value.toStringAsFixed(0)} ₹")),
                            ],
                          ),
                          Divider(
                            height: 30,
                          ...
                          Obx(() => NoticeRow(
                              text:
                                  "You will receive ${controller.quarterlyInterest.value.toStringAsFixed(0)} ₹ every quarter.")),
                          10.height,
                          Obx(() => NoticeRow(
                              text:
                                  "At the end of the term, you will get your deposit amount ${controller.loanAmount.value} ₹ back.")),
                        ],
                      ),
                    ),
                  ),
