...
import 'package:emi_calc/controller/national_saving_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:get/get.dart';

class NationalSaving extends StatelessWidget {
  NationalSaving({super.key});
  NAtionalSavingController controller = Get.put(NAtionalSavingController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: commonappbar(text: "National Saving Certificate"),
